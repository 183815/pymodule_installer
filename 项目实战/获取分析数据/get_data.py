import os, shutil, zipfile, requests, decimal, random, time, smtplib, hashlib, copy, csv, imageio, moviepy, ez_setup, \
    ...
    configparser, tqdm, math, xlrd, pymysql, wxpy,office
...
def get_excel():
    path="H:\项目\数据\excel.xlsx"
    excel=office.excel.fake2excel(columns=["name","job","company_prefix"],rows=100,path=path)
    return excel
